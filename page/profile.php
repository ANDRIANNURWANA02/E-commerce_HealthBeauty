  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="./dashboard.php" class="brand-link">
        <img src="./dist/img/kecantikan.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <a href="./dist/img/andri.jpg">
                      <img class="profile-user-img img-fluid img-circle" src="./dist/img/andri.jpg"
                        alt="User profile picture">
                    </a>
                  </div>

                  <h3 class="profile-username text-center">Andrian Nurwana</h3>
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <p class="text-muted">
                    Information System  from the STTNF
                  </p>
                  ...
                  <p class="text-muted">Bogor, Jawa Barat</p>
                  ...
                  <p class="text-muted">Be youre self</p>
                </div>
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
                    ...
                    <div class="tab-pane" id="settings">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" id="inputExperience" placeholder="Experience" required></textarea>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputSkills" class="col-sm-2 col-form-label">Skills</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputSkills" placeholder="Skills" required>
                          </div>
                        </div>
                        <div class="form-group row">
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023.<b>Develop By Andrian Nurwana</b> </strong> All rights reserved.
    </footer>
