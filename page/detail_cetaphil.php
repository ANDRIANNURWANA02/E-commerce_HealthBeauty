    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="../asset/images/loreal.jpg" class="image-popup"><img src="../asset/images/cetapil.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price"><span>Rp.140.000</span></p>
						<div class="row mt-4">
							<div class="col-md-6">
