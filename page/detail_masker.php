		...
		<div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				<p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home</a></span> <span class="mr-2"><a
							href="product.php">Product</a></span></p>
	...
	<div class="container">
		<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="../asset/images/scarlett.jpg" class="image-popup"><img src="../asset/images/masker.jpg"
							class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					<h3>Masker Wajah Tea Tree</h3>
					...
					<div class="row mt-4">
						...
						<div class="input-group col-md-6 d-flex mb-3">
							...
							// Memeriksa apakah tombol "Tambah" diklik
							if (isset($_POST['quantity'])) {
								$id_produk = $_POST['id_produk'];
								tambahProduk($id_produk);
							}
							// Fungsi untuk menambahkan jumlah produk ke keranjang belanja
							function tambahProduk($id_produk)
							{
...
<section class="ftco-section bg-light">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm col-md-6 col-lg ftco-animate">
				<div class="product">
					<a href="detail_mastin.php" class="img-prod"><img class="img-fluid" src="../asset/images/mastin.jpg"
							alt="Colorlib Template">
						<div class="overlay"></div>
					</a>
					<div class="text py-3 px-3">
