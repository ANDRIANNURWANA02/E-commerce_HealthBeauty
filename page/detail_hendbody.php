    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="../asset/images/hendbody.jpg" class="image-popup"><img src="../asset/images/hendbody.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3>HandBody Lotion</h3>
					...
					<div class="product">
						...
						<div class="text py-3 px-3">
							...
							<p class="bottom-area d-flex px-3">
								<a href="beli_sekarang.php" class="add-to-cart text-center py-2 mr-1"><span>Tambah Troli <i
