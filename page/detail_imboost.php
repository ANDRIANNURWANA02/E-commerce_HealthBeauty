    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="../asset/images/imboos.jpg" class="image-popup"><img src="../asset/images/imboos.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
          	...
          	<p><a href="beli_sekarang.php" class="btn btn-black py-3 px-5">Beli Sekarnag</a></p>
    			</div>
    		</div>
    	</div>
    </section>
